...
if ($k==1) {
	...
	<input type="hidden" id="spaceever" value="<?php echo $row['id'] ?>" />
	<ul onClick="fillever('<li id=\'<?php echo $row['id'] ?>\'><?php echo $row['spot'] ?></li>');addever('<?php echo $row['id'] ?>')"><?php echo $row['spot']?></ul>    
