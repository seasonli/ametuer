...
<div id="d_outer"><div id="d_inner">
	<div id="half">
		<div style="float:left; margin:70px 0 50px 0px; width:470px; border-bottom:2px solid #ddd; font-size:14px; background:#eee">
			<div class="f-green" style="float:left; margin:10px 0 0 10px; width:460px; line-height:40px">注册更远</div>
	...
	<div id="half">
		<form action="-login.php" method="post">
			<div style="float:right; padding:50px 0 0 0; width:360px; font-size:14px">
				<div class="f-green" style="float:left; margin:10px 0 0 0; width:360px; line-height:40px">已有帐号，登录</div>
				...
				<label style="float:right; margin:10px 47px 0 0"><input style="height:38px; width:80px" value="登录" type="submit" /></label>
				<div id="logininfo" class="f-green" style="float:left; margin:20px 0; width:360px; height:20px; font-size:12px">
