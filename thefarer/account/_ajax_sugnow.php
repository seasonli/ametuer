...
if ($k==1) {
	...
	<input type="hidden" id="spacenow" value="<?php echo $row['id'] ?>" />
	<ul onClick="fillnow('<li id=\'<?php echo $row['id'] ?>\'><?php echo $row['spot'] ?></li>'); addnow('<?php echo $row['id'] ?>')"><?php echo $row['spot']?></ul>    
