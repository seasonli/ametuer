...
class Wechat {
	 ...
	 */
	private $wechatOptions=array('token'=>'','account'=>'admin@thefarer.com','password'=>'tfweixin0421715YNWA');	//
	private $cookiefilepath = "http://www.thefarer.com/tmp/"; //以文件形式保存cookie的保存目录，肯定是可写的
	public $webtoken = 'tfweixin0421715YNWA';  
	private $webtokenStoragefile = "http://www.thefarer.com/_wechat/index.php";  //微信公共平台的token存储文件，就是公共平后台网页的token
	...
	public function login(){
		...
		$postfields["imgcode"] = "nvwz";
		$postfields["set-cocokie"] = "1374471906330";
		$postfields["f"] = "json";
