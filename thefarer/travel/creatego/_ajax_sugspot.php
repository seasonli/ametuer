...
if ($k==1) {
	...
	<ul onClick="fillspot('<li id=\'<?php echo $row['id'] ?>\' onClick=\'$(this).fadeOut(300); removespot(this.id)\'><?php echo $row['spot'] ?></li>');addspot('<?php echo $row['id'] ?>')"><?php echo $row['spot']?></ul>    
